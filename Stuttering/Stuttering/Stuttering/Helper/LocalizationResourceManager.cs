...
namespace Stuttering.Helper
{
    public class LocalizationResourceManager : INotifyPropertyChanged
    {
        ...
        public string this[string text]
        {
            get
            {
                return StutteringResources.ResourceManager.GetString(text, StutteringResources.Culture);
            }
        }
        ...
        public void SetCulture(CultureInfo language)
        {
            ...
            StutteringResources.Culture = language;
        ...
        public CultureInfo CurrentCulture => StutteringResources.Culture ?? Thread.CurrentThread.CurrentUICulture;
