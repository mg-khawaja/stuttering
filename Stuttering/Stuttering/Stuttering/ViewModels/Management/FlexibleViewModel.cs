...
{
    public class FlexibleViewModel : BaseViewModel
    {
        ...
        public FlexibleViewModel(INavigation _navigation)
        {
        ...
        {
            IsBusy = true;
            Chapters = SQLiteDbManager.GetModuleChapters(ModuleType.Flexible);
            IsBusy = false;
        }
